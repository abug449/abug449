...
#The Credit For This Code Goes To abug449
...
\033[1;92m.......................... DeVil Aziz......................

\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗

\033[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   ABU G ARMY

\033[1;93m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 

\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mabug449\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
print  """
 ...
 \033[1;96m ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈
  ...
  \033[1;96m ─────────────•◈•──────────  
   ...
   \033[1;92m███████▒▒Welcome To ABU G ARMY▒▒████████

\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mabug449\033[1;95m♡╭──────────•◈•──────────╮♡

\033[1;94mAuthor\033[1;91m: \033[1;91mabug449

\033[1;94mabug449\033[1;91m: \033[1;91▒▓██████████████]99.9

\033[1;94mFacebook\033[1;91m: \033[1;91mbrand.abu.g

\033[1;94mWhatsapp\033[1;91m: \033[1;91m+923031421214

\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mabug449\033[1;95m♡╰──────────•◈•──────────╯♡"""

jalan('              \033[1;96m.................... ABU G ARMY.....................:')
...
print "\033[1;93m♡─────╱▔▔▔▔┊┊┊┊▔▔▔▔╲───────♡\033[1;96mLogin ABU G ARMY\033[1;95m♡╰──────────•◈•──────────╯♡"

CorrectUsername = "abug449"

CorrectPassword = "abug449"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            print "Logged in successfully as " + username #Dev:abug449
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://m.facebook.com/brand.abu.g')

    else:

        print "\033[1;94mWrong Username"

        os.system('xdg-open https://m.youtube.com/abug449')
...
def login():
	...
	try:
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mabug449\033[1;95m♡──────────•◈•──────────♡"
...
def pilih_super():
	...
	if peak =="":
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mDevilaziz\033[1;95m♡──────────•◈•──────────♡"
		...
		try:
			...
			raw_input("\n\033[1;96m[\033[1;94mabug449\033[1;96m]")
	...
	print "  \033[1;93m«---•◈•---Developed By love---•◈•---»" #Dev:abug449
...
: \033[1;96m .....ABU G ARMY........... \033[1;93m :
...
♡──────────────•◈•──────────────♡.' 
	...
	raw_input("\n\033[1;92m[\033[1;94mabug449\033[1;96m]")
